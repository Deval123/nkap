...
/**
 * How a configured provider installation is routed: the currency it settles in, and the
 * base URL a payment routed to it is actually submitted against.
 *
 ...
 */
public record ProviderRouting(ProviderId provider, Currency currency, String baseUrl) {
