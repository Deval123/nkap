 ...
 *
 * <p>The fourth copy of this class, beside {@code server}'s, {@code provider-mpesa}'s and
 * {@code provider-mtn}'s, because the repository has no shared test module to hold one.
 */
final class RecordToString {
     ...
     */
    static void assertEveryComponentPrintedOrMasked(Record record, Set<String> printed, Set<String> masked,
                                                    String marker) {
